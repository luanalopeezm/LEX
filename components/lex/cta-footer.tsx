...
export function CtaFinal() {
  return (
    <section id="nosotros" className="mx-auto max-w-6xl px-5 pb-24">
      <div className="relative overflow-hidden rounded-3xl bg-indigo-600 px-8 py-16 text-center text-white">
        ...
        <div className="relative">
          <h2 className="font-display text-pretty text-3xl font-semibold sm:text-4xl">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <a
              href="/"
              className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-indigo-700 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-indigo-50"
            >
              Probar el prototipo
...
const PRODUCTO = [
  { href: "/", label: "Probar el prototipo" },
          ...
          <div className="flex flex-wrap gap-12 text-sm">
            <div>
              ...
              <ul className="mt-3 space-y-2 text-slate-500">
                {PRODUCTO.map((l) => (
                  <li key={l.label}>
                    <a href={l.href} className="hover:text-indigo-700">
                      {l.label}
                    </a>
                  </li>
                ))}
